...
export const CITIES: CityData[] = [
    ...
    initialReports: [
      {
        ...
        imageUrl: '', status: 'Selesai', date: fmtDate(new Date(now.getTime() - 7 * 86400000)),
      ...
      },
      {
        ...
        imageUrl: '', status: 'Diproses', date: fmtDate(new Date(now.getTime() - 4 * 86400000)),
      ...
      },
      {
        ...
        imageUrl: '', status: 'Diverifikasi', date: fmtDate(new Date(now.getTime() - 2 * 86400000)),
    ...
    rewardItems: [
      {
        ...
        imageUrl: '', partner: 'Dinas Perhubungan Surakarta',
      },
      {
        ...
        imageUrl: '', partner: 'Shopee Indonesia',
      },
      {
...

  {
    ...
    initialReports: [
      { id: 'rep-1', title: 'Tumpukan Sampah di Bantaran Cikapundung', description: 'Sampah rumah tangga menumpuk di bantaran Sungai Cikapundung, berpotensi banjir saat hujan.', locationName: 'Bantaran Cikapundung, Braga, Bandung', coordinates: { x: 48, y: 50 }, imageUrl: '', status: 'Selesai', date: fmtDate(new Date(now.getTime() - 7 * 86400000)), reportedBy: 'Dewi Sartika', wasteType: 'Anorganik', officerName: 'Agus Hermawan', pointsAwarded: 150 },
      { id: 'rep-2', title: 'Sampah Pasar Menumpuk di Pasar Baru', description: 'Sisa sayur dan buah membusuk di area belakang Pasar Baru Bandung.', locationName: 'Jl. Pasar Baru, Bandung', coordinates: { x: 60, y: 52 }, imageUrl: '', status: 'Diproses', date: fmtDate(new Date(now.getTime() - 4 * 86400000)), reportedBy: 'Dewi Sartika', wasteType: 'Organik', officerName: 'Deden Saepul' },
      { id: 'rep-3', title: 'Pembuangan Liar di Tepi Jalan', description: 'Kasur bekas dan sampah besar dibuang liar di tepi Jalan Soekarno-Hatta.', locationName: 'Jl. Soekarno-Hatta, Kiaracondong', coordinates: { x: 65, y: 42 }, imageUrl: '', status: 'Diverifikasi', date: fmtDate(new Date(now.getTime() - 2 * 86400000)), reportedBy: 'Rina Marlina', wasteType: 'Campuran' },
    ],
    rewardItems: [
      { id: 'rew-1', title: `Tiket Gratis ${'Trans Metro Bandung (TMB)'}`, pointsCost: 300, category: 'Transportasi', description: '1x perjalanan gratis menggunakan Trans Metro Bandung koridor mana saja.', imageUrl: '', partner: 'Dinas Perhubungan Bandung' },
      { id: 'rew-2', title: 'Saldo ShopeePay Rp 25.000', pointsCost: 1000, category: 'Voucher', description: 'Voucher digital saldo ShopeePay senilai Rp 25.000.', imageUrl: '', partner: 'Shopee Indonesia' },
    ...
    environmentalFacts: [
      ...
      { id: 'fact-2', title: 'PLTSa Bandung: Solusi Energi', snippet: 'Bandung tengah mengembangkan PLTSa untuk mengolah sampah menjadi listrik.', fullText: 'Pembangkit Listrik Tenaga Sampah direncanakan untuk mengurangi volume sampah dan menghasilkan energi bersih bagi kota Bandung.', imageUrl: '' },
      { id: 'fact-3', title: 'Mengapa Memilah Sampah dari Rumah?', snippet: 'Memilah sampah dari rumah mengurangi beban penyortiran manual.', fullText: 'Dengan memilah sampah Anda, Anda berkontribusi menyelamatkan bumi dan membantu petugas kebersihan Bandung.', imageUrl: '' },
    ],
  },

  {
    ...
    initialReports: [
      { id: 'rep-1', title: 'Sampah Plastik di Pinggir Kali Mas', description: 'Sampah plastik menumpuk di pinggir Kali Mas, menghambat aliran air.', locationName: 'Bantaran Kali Mas, Bubutan, Surabaya', coordinates: { x: 50, y: 55 }, imageUrl: '', status: 'Selesai', date: fmtDate(new Date(now.getTime() - 7 * 86400000)), reportedBy: 'Rudi Hartono', wasteType: 'Anorganik', officerName: 'Joko Susilo', pointsAwarded: 150 },
      { id: 'rep-2', title: 'Limbah Pasar di Pasar Genteng', description: 'Sisa dagangan membusuk di area Pasar Genteng.', locationName: 'Pasar Genteng, Surabaya', coordinates: { x: 50, y: 52 }, imageUrl: '', status: 'Diproses', date: fmtDate(new Date(now.getTime() - 4 * 86400000)), reportedBy: 'Rudi Hartono', wasteType: 'Organik', officerName: 'Suparno' },
      { id: 'rep-3', title: 'Pembuangan Liar di Wonokromo', description: 'Sampah besar dibuang liar di pinggir jalan Wonokromo.', locationName: 'Jl. Wonokromo, Surabaya', coordinates: { x: 58, y: 60 }, imageUrl: '', status: 'Diverifikasi', date: fmtDate(new Date(now.getTime() - 2 * 86400000)), reportedBy: 'Maya Indah', wasteType: 'Campuran' },
    ],
    rewardItems: [
      { id: 'rew-1', title: `Tiket Gratis ${'Trans Semanggi Surabaya (TSS)'}`, pointsCost: 300, category: 'Transportasi', description: '1x perjalanan gratis naik Trans Semanggi Surabaya.', imageUrl: '', partner: 'Dinas Perhubungan Surabaya' },
      { id: 'rew-2', title: 'Saldo ShopeePay Rp 25.000', pointsCost: 1000, category: 'Voucher', description: 'Voucher digital ShopeePay senilai Rp 25.000.', imageUrl: '', partner: 'Shopee Indonesia' },
    ...
    environmentalFacts: [
      ...
      { id: 'fact-2', title: 'PLTSa Benowo: Energi Bersih', snippet: 'PLTSa Benowo mengubah sampah menjadi listrik untuk warga Surabaya.', fullText: 'Pembangkit Listrik Tenaga Sampah Benowo memanfaatkan gas metana dari gunungan sampah untuk menghasilkan listrik.', imageUrl: '' },
      { id: 'fact-3', title: 'Mengapa Memilah Sampah?', snippet: 'Memilah sampah dari rumah mengurangi beban TPA Benowo.', fullText: 'Dengan memilah sampah Anda, Anda berkontribusi pada Surabaya yang lebih bersih dan sehat.', imageUrl: '' },
    ],
  },
];
...
export function generateProfiles(city: CityData): { Masyarakat: UserProfile; Petugas: UserProfile; BankSampah: UserProfile } {
  return {
    Masyarakat: {
      ...
      role: 'Masyarakat', points: 2450, avatar: '', phone: '0812-3456-7890',
    ...
    Petugas: {
      ...
      role: 'Petugas', points: 1200, avatar: '', phone: '0823-4567-8912',
    ...
    BankSampah: {
      ...
      role: 'BankSampah', points: 850, avatar: '', phone: '0856-7890-1234',
